...
class Medma_AttributeCustomize_Adminhtml_Catalog_Product_AttributeController extends Mage_Adminhtml_Catalog_Product_AttributeController
{
    ...
    {	
        ...
        if ($data) {
            ...
            if($data['is_filterable'] != 0)
			{
				if (isset($data['filterable_categories'])) {
					$data['filterable_categories'] = implode(",", $data['filterable_categories']);
				}
            }
            else
				$data['filterable_categories'] = '';
